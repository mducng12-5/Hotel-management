#include "login_logout_receptionist.hpp"

void log_in_Receptionist::LogInReceptionist()
{
    log_in_interface: /* log in interface flag*/
        string receptionist_username, receptionist_password;
        cout << "Please enter username: ";
        cin.ignore();
        getline(cin, receptionist_username);
        cout << "Please enter password: ";
        getline(cin, receptionist_password);
        ifstream file("database/receptionist.csv");
        if(!file.is_open())
        {
        ...
        while(getline(file, line))
        {
            ...
            getline(readline, id, ',');
            if(username == receptionist_username && receptionist_password == password)
            {
...
void log_out_Receptionist::LogOutReceptionist()
{
